package tech.gamesupport.woo.iapi;
...
import tech.gamesupport.woo.iapi.bean.DBSQLType;
import tech.gamesupport.woo.iapi.bean.ObjDiff;
import tech.gamesupport.woo.iapi.core.InternalWooClient;
...
import tech.gamesupport.woo.iapi.service.product.model.SQLInfo;
...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InternalWooClient client = InternalWooClient
                ...
                .httpClient(new OkHttpClient.Builder().connectTimeout(Duration.ofSeconds(15)).readTimeout(Duration.ofSeconds(15)).build())
